...
export default function Registro() {
  ...
  const submitEstudiante = async () => {
    ...
    setLoading(true);
    try {
      // PUNTO A: El backend recibe la contraseña y aplica bcrypt cost=10
        ...
        <div className="reg-left">
          ...
          {tab === "empresa" && (<>
            <div className="reg-notice">
              <strong>Registro rápido.</strong> Solo pedimos lo esencial. Una vez dentro completas tu perfil con RFC, domicilio fiscal, datos del asesor y más.
            </div>

            <div className="form-section"><div className="form-section-line"/><span className="form-section-label">Datos de la empresa</span><div className="form-section-line"/></div>
            ...
            <div className="form-section"><div className="form-section-line"/><span className="form-section-label">Contacto principal</span><div className="form-section-line"/></div>
            ...
            <div className="form-section"><div className="form-section-line"/><span className="form-section-label">Datos de acceso</span><div className="form-section-line"/></div>
          ...
          {/* ══ ESTUDIANTE ══ */}
          {tab === "estudiante" && (<>
            <div className="form-section"><div className="form-section-line"/><span className="form-section-label">Datos personales</span><div className="form-section-line"/></div>
          ...
          <div className="login-row">
            ¿Ya tienes cuenta? <button className="login-link" onClick={() => navigate("/login")}>Inicia sesión</button>
          </div>
        </div>
