...
router.get('/me', authMiddleware, authController.obtenerMiPerfil);
router.put('/me', authMiddleware, uploadPerfilImagen.single('foto_perfil'), authController.actualizarMiPerfil);
