<?php
// PUNTO A: Registro seguro con password_hash + BCRYPT, cost=10
...
$id_rol   = (int)($body['id_rol'] ?? 2); // 2 = Estudiante por defecto
...
// PUNTO A: Hashing con Bcrypt, cost=10 (mínimo requerido)
...
try {
    ...
    // Si el rol es Estudiante (2), crear registro en tabla Estudiantes
    if ($id_rol === 2) {
